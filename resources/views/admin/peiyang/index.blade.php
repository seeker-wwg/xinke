...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 培养计划中心 <span class="c-gray en">&gt;</span> 培养计划管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c" style="border: 1px solid #8f002f;width: 80%;height: 60px;box-shadow:3px 3px 5px 4px rgba(0,0,0,0.5); margin: 0 auto; padding-top: 20px;">
            ...
            <select class="select" style="width: 20%;height: 30px" name="jiaoxuefx" id="jiaoxuefx">
                <option value="0">请选择培养方向</option>
		...
		<button type="submit" class="btn btn-success radius" id="searchXH" name=""><i class="Hui-iconfont">&#xe665;</i> 搜培养计划</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="deleteAll()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			...
			<a href="javascript:;" onclick="member_add('添加培养计划','{{url("admin/peiyang/tianjia")}}','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加培养计划</a>
...
$(function(){
    mydatatable = $('.table-sort').dataTable({
        ...
        "columns": [
            {"defaultContent": ""},
            {'data':'id'},
            {'data':'zhuanyedm.zy_daima'},
            {'data':'jiaoxuefx.jxfx_name'},
        ...
        "createdRow":function(row,data,dataIndex){
			...
			var fuxuank='<input type=\'checkbox\' name=\'py_id\' value='+data.id+' >';
			$(row).find('td:eq(0)').html(fuxuank);
			var anniu = '<a title="编辑" href="javascript:;" onclick="member_edit(\'编辑\',\'/admin/peiyang/xiugai/'+data.id+'\',4,\'\',510)" ' +
