...
<div class="page-container">
	...
	<a href="javascript:;" onclick="admin_add('添加管理员','{{url('admin/stream/tianjia')}}','800','300')"
       class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a>

		</span> <span class="r">共有数据：<strong>{{\DB::table('manager')->count()-1}}</strong> 条</span> </div>
    <table class="table table-border table-bordered table-bg">
        <thead>
        <tr>
            <th scope="col" colspan="100">管理员列表</th>
        </tr>
        <tr class="text-c">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>
                    ...
                    <a title="编辑" href="javascript:;"
                       onclick="admin_edit('管理员编辑','/admin/role/xiugai/{{$v->mg_id}}','1','800','500')"
