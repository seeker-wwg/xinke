...
<div class="page-container">
	...
	<a href="javascript:;" onclick="admin_add('添加角色','{{url('admin/stream/tianjia')}}','800','300')"
       class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a>

		</span> <span class="r">共有数据：<strong>{{\DB::table('role')->count()}}</strong> 条</span> </div>
    <table class="table table-border table-bordered table-bg">
        <thead>
        <tr>
            <th scope="col" colspan="100">角色列表</th>
        </tr>
        <tr class="text-c">
            <th width="4%"><input type="checkbox" name="" value=""></th>
            <th width="4%">ID</th>
            <th width="6%">角色名称</th>
            <th width="30%">对应权限ids</th>
            <th width="30%">权限ca</th>
            <th width="10%">创建时间</th>
            <th width="*">操作</th>
        </tr>
            ...
            <tr class="text-c">
                ...
                <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>
                    ...
                    <a title="编辑" href="javascript:;"
                       onclick="admin_edit('角色编辑','/admin/role/xiugai/{{$v->role_id}}','1','800','500')"
